    ...
    */
    ...
    FOR i IN 0..p_months_ahead LOOP
        ...
        IF TO_REGCLASS(v_table_name) IS NULL THEN
            ...
            RAISE NOTICE '✅ Partition Created: % (Range: % to %)', v_table_name, v_start_date, v_end_date;
        ELSE
            RAISE NOTICE 'ℹ️ Partition already exists: %', v_table_name;
        END IF;
    END LOOP;
...
COMMENT ON FUNCTION audit.auto_manage_partitions() IS 'Automatically creates and manages monthly partitions for audit.logging_dml';
